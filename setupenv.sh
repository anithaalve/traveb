...
######################################################################
USER=admin # User that will have ownership (chown) to /usr/local/bin and /usr/local/lib
...
#$virtualenv -p python3.6 virtname //run this to create a virtual environment
